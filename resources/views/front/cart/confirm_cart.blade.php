                                ...
                                <div class="cart-information row">
                                   ...
                                   <div class="cart-product promotional-code-content row">
                                      ...
                                      <div class="info-facture mt-40">
                                            ...
                                            <div class="col-sm-5">
                                                <a class="apply_codepromo fw-400" data-url="{!! route('get_discount') !!}" onclick="apply_get_discount(this)" style="line-height: 55px;"><i class="fa fa-circle-o"></i>&nbsp;&nbsp;Appliquer</a>
                                            </div>
                                      </div>
