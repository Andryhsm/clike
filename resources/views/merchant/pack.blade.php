...
<div role="tabpanel" id="tab-sale" class="tab-panel tab-panel-customer col-lg-12 col-xs-12 col-md-12 col-sm-12 pb-40">
        	<div class="section-title">
        	</div>
            <ul class="nav nav-tabs" style="font-size: 17px !important;margin-top: 15px !important;width: 60% !important;" role="tablist">
                ...
                <div role="tabpanel" class="tab-pane active" id="uploadTab">
                	...
                	<div class="row" style="width: 105%;">
                        ...
                        <div class="col-sm-2 point5 border-green" style="margin-top: 30rem;">
                            <div class="row bg-grey p-0"><p><b>Compte employés</b></p></div>
                            <div class="row bg-white p-0"><p><b>Nombre d’articles</b></p></div>
                            <div class="row bg-grey p-0"><p><b>Base de données clients</b></p></div>
                            <div class="row bg-white p-0"><p><b>Visibilité des produits</b></p></div>
                            <div class="row bg-grey p-0"><p><b>Frais de transaction</b></p></div>
                            <div class="row bg-white p-0"><p><b>Codes promo</b></p></div>
                            <div class="row bg-grey p-0"><p><b>Encaissement physique</b></p></div>
                            <div class="row bg-white p-0"><p><b>Rapport d’activité</b></p></div>
                            <div class="row bg-grey p-0"><p><b>Fiche boutique</b></p></div>
                        ...
                        <div class="col-sm-2 point5 border-green">
                            ...
                            <div class="row bg-grey p-0"><p>illimité</p></div>
                            <div class="row bg-white p-0"><p>illimité</p></div>
                            <div class="row bg-grey p-0"><p>illimité</p></div>
                            <div class="row bg-white p-0">
                                <p><i class="fa fa-times"></i></p>
                            </div>
                            <div class="row bg-grey p-0"><p><i class="fa fa-times"></i></p></div>
                            <div class="row bg-white p-0">
                                <p><i class="fa fa-check"></i></p>
                            </div>
                            <div class="row bg-grey p-0"><p><i class="fa fa-check"></i></p></div>
                            <div class="row bg-white p-0">
                                <p><i class="fa fa-check"></i></p>    
                            </div>
                            <div class="row bg-grey p-0"><p><i class="fa fa-check"></i></p></div>
                        ...
                        <div class="col-sm-2 point5 border-green shadow-engagement">
                            ...
                            <div class="row bg-grey p-0"><p>3,5%</p></div>
                            <div class="row bg-white p-0">
                                <p><i class="fa fa-check"></i></p>
                            </div>
                            <div class="row bg-grey p-0"><p><i class="fa fa-check"></i></p></div>
