                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                            <div class="box-body">
                                                ...
                                                <div class="form-group">
                                                    {!! Form::label('attribute_set', 'Attribute Set', ['class' => 'col-sm-4 control-label']) !!}
                                                    <div class="col-sm-7">
                                                ...
                                                <div class="form-group">
                                                    {!! Form::label('brand', 'Marque', ['class' => 'col-sm-4 control-label']) !!}
                                                    <div class="col-sm-7">
                                                ...
                                                <div class="form-group french_input">
                                                    {!! Form::label('fr_product_name', 'Nom produit', ['class' => 'col-sm-4 control-label']) !!}
                                                    <div class="col-sm-7">
                                                ...
                                                <div class="form-group">
                                                    {!! Form::label('serial_number', 'Numéro de série / Code BAR', ['class' => 'col-sm-4 control-label']) !!}
                                                    <div class="col-sm-7">
                                                ...
                                                <div class="form-group">
                                                    {!! Form::label('product_url', "Clé d'URL", ['class' => 'col-sm-4 control-label']) !!}
                                                    <div class="col-sm-7">
                                                ...
                                                <div class="form-group">
                                                    {!! Form::label('price', 'Prix', ['class' => 'col-sm-4 control-label']) !!}
                                                        <div class="col-sm-7">
                                                ...
                                                <div class="form-group tag-autocomplete hidden">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('fr_title', "Titre", ['class' => 'col-sm-4 control-label']) !!}
                                                <div class="col-sm-7">
                                                    {!! Form::text("fr_title", ($product) ?$product->french->meta_title : null , ['class' => 'form-control','id'=>'fr_title','placeholder'=>"Entrer le nom du produit"]) !!}
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                {!! Form::label('fr_meta_description', "Meta Description", ['class' => 'col-sm-4 control-label']) !!}
                                                <div class="col-sm-7">
                                                    {!! Form::text("fr_meta_description", ($product) ?$product->french->meta_description : null , ['class' => 'form-control','id'=>'fr_meta_description','placeholder'=>"Idem  + type de produit"]) !!}
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                {!! Form::label('fr_meta_keywords', "Meta Mot-clé", ['class' => 'col-sm-4 control-label']) !!}
                                                <div class="col-sm-7">
                                            ...
                                            <div class="form-group">
                                                {!! Form::label('fr_og_title', "OG Titre", ['class' => 'col-sm-4 control-label']) !!}
                                                <div class="col-sm-7">
                                                    {!! Form::text("fr_og_title", ($product) ?$product->french->og_title : null , ['class' => 'form-control','id'=>'fr_og_title','placeholder'=>"Utiliser le modèle: « Marque - Nom du modèle sur Clickee »"]) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('fr_og_description', "OG Description", ['class' => 'col-sm-4 control-label']) !!}
                                                <div class="col-sm-7">
                                                    {!! Form::text("fr_og_description", ($product) ?$product->french->og_description : null , ['class' => 'form-control','id'=>'fr_og_title','placeholder'=>"Insérer les deux premières lignes de la description","maxlength"=>"200"]) !!}
                                                </div>
                                            </div>
