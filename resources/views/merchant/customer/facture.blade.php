...
<body>
    ...
    <div class='container ptb-40'>
        <div class="col-lg-12 col-md-12 col-ms-12 col-xs-12 text-center pb-20">
            <p>
        ...
        <div class="col-lg-12 col-md-12 col-ms-12 col-xs-12">
            <div class="logo text-center">
                <img style="max-width: 20%;" src="{!! URL::to('/') !!}/images/logoPdf.png" alt="logo clickee"/>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-ms-12 col-xs-12 table-responsive pt-20">
