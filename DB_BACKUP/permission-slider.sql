...
-- Export de données de la table clickee.permission : ~39 rows (environ)
...
INSERT INTO `permission` (`permission_id`, `module_name`, `parent_id`, `route`) VALUES
	...
	(18, 'Banner Manager', 3, 'banner.index,banner.create,banner.edit'),
	...
	(49, 'Pack Manager', 3, 'pack.index,pack.create,pack.edit'),
	(50, 'Slider Manager', 3, 'slider.index,slider.create,slider.edit');
